<x-guest-layout>
    <div class="w-full max-w-sm p-6 border-2 border-teal-500 rounded-lg shadow-md text-center">
        ...
        <!-- Título -->
        <h1 class="text-teal-600 font-bold text-xl mb-6 uppercase">Seja Bem-Vindo(a)!</h1>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-4 text-left">
                ...
                <input id="email" 
                       ...
                       class="w-full mt-1 px-3 py-2 border-2 border-teal-500 rounded-full text-teal-600 placeholder-teal-300 focus:outline-none focus:ring-2 focus:ring-teal-500" />
            ...
            <div class="flex items-center mb-4">
                <input id="remember_me" 
                       type="checkbox" 
                       name="remember"
                       class="text-teal-600 border-teal-500 rounded focus:ring-teal-500">
            ...
            <div class="mb-4 text-left">
                @if (Route::has('password.request'))
                    <a class="text-xs text-teal-600 hover:underline" href="{{ route('password.request') }}">
                        Esqueceu sua senha?
                    </a>
                @endif
            </div>
